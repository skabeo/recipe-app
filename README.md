...
<div align="center">
    <br>
  <h1 style="font-size: 35px; color: lightblue"><b>Recipe app</b></h1>
</div>

# 📗 Table of Contents <a id="table-of-contents"></a>

- [📗 Table of Contents ](#-table-of-contents-)
- [📖 Recipe app Project ](#-catalog-ruby-project-)
...
Feel free to check the [issues page](https://github.com/0sugo/recipe-app/issues).
